...
class Main extends Component {
  ...
  hangleFillGenreState =(field,value)=>{
  ...
  render() {
    ...
    const {
      ...
      const subgenres = this.state.genres.find((genre) => genre.name === this.state.selectedGenre) ?.subgenres;
    ...
    return (
        ...
        {dynamicSteps.map((label,index)=>(
            <div key={label} className={(index === activeStep ? "activeColor panelIndicator" : "panelIndicator")}>
